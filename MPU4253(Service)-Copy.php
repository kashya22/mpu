...
<section class="py-20 bg-gradient-to-r from-green-50 to-blue-50">
    <div class="container mx-auto px-4">
        <h2 class="text-4xl font-bold text-center mb-16 text-gray-800">Our Plans</h2>
        <div class="max-w-5xl mx-auto">
            <!-- Single line, centered text -->
            <p class="text-gray-600 text-center mb-8">Check out our available plans that help improve your wellness journey!</p>
            
            <div class="text-center mb-32">
					<button onclick="window.location.href='MPU4253(Subscription)-Copy.php'" class="group relative px-12 py-4 text-lg font-medium text-white bg-gradient-to-r from-green-500 to-blue-500 rounded-full hover:opacity-90 transition-all duration-300 pulse">
