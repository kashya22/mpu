                ...
                <div class="grid md:grid-cols-2 gap-10">
                    ...
                    <div class="subscription-card glass rounded-2xl overflow-hidden relative">
                        <div class="absolute top-0 right-0">
                            <div class="bg-gradient-to-r from-green-500 to-blue-500 text-white text-sm font-medium px-4 py-1 rounded-bl-lg">
                                Current Plan
                            </div>
                        </div>
                        <div class="p-8">
                            ...
                            <div class="text-center mt-8">
                                <button class="px-8 py-3 text-white bg-gradient-to-r from-green-500 to-blue-500 rounded-full hover:opacity-90 transition-all">
                                    Current plan
                                </button>
                            </div>
                        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex justify-center space-x-6">
                    <button onclick="window.location.href='MPU4253(Dashboard).php'" class="px-8 py-3 text-white bg-gradient-to-r from-green-500 to-blue-500 rounded-full hover:opacity-90 transition-all">
                        Return to Dashboard
                    </button>
                </div>
            </div>
